...
var _user$project$Main$minute = {inUnit: _elm_lang$core$Time$inMinutes, unit: _elm_lang$core$Time$minute};
var _user$project$Main$hour = {inUnit: _elm_lang$core$Time$inHours, unit: _elm_lang$core$Time$hour};
var _user$project$Main$without = F2(
	function (_p0, t) {
		var _p1 = _p0;
		var wholeUnits = _elm_lang$core$Basics$toFloat(
			_elm_lang$core$Basics$truncate(
				_p1.inUnit(t)));
		return t - (wholeUnits * _p1.unit);
	});
var _user$project$Main$wholeMinutes = function (t) {
	return _elm_lang$core$Basics$truncate(
		_elm_lang$core$Time$inMinutes(
			A2(_user$project$Main$without, _user$project$Main$hour, t)));
};
var _user$project$Main$wholeHours = function (t) {
	return _elm_lang$core$Basics$truncate(
		_elm_lang$core$Time$inHours(t));
};
var _user$project$Main$timeToEntry = F2(
	function (start, t) {
		var delta = t - start;
		var hms = A2(
			_elm_lang$core$String$join,
			':',
			{
				...
				_0: _elm_lang$core$Basics$toString(
					_user$project$Main$wholeHours(delta)),
				_1: {
					ctor: '::',
					_0: _elm_lang$core$Basics$toString(
						_user$project$Main$wholeMinutes(delta)),
					_1: {
						ctor: '::',
						_0: _elm_lang$core$Basics$toString(
							_elm_lang$core$Time$inSeconds(
								A2(_user$project$Main$without, _user$project$Main$minute, delta))),
						_1: {ctor: '[]'}
					}
				}
			});
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(hms),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Main$viewLog = function (_p2) {
	var _p3 = _p2;
	var _p4 = _p3.start;
	var fullLog = A2(
		_elm_lang$core$Basics_ops['++'],
	...
	var entries = A2(
		_elm_lang$core$List$map,
		_user$project$Main$timeToEntry(_p4),
		fullLog);
	return A2(
...
var _user$project$Main$viewNow = function (_p5) {
	var _p6 = _p5;
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Card$block,
		{
			ctor: '::',
			_0: _rundis$elm_bootstrap$Bootstrap_Card_Block$primary,
			_1: {
				ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_user$project$Main$timeToEntry, _p6.start, _p6.now),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$Unit = F2(
	function (a, b) {
		return {inUnit: a, unit: b};
	});
var _user$project$Main$Stopped = function (a) {
...
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Main$Loaded, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Main$simpleUpdate = F2(
	function (msg, model) {
		...
		do {
			if (_p7.ctor === '_Tuple2') {
				switch (_p7._1.ctor) {
					case 'Loaded':
						if (_p7._0.ctor === 'Start') {
							return _user$project$Main$Started;
						} else {
							break _v3_8;
						}
					case 'Started':
					...
					case 'Running':
						switch (_p7._0.ctor) {
							...
							case 'Remember':
								var _p9 = _p7._1._0;
								var log = {ctor: '::', _0: _p9.now, _1: _p9.log};
								return _user$project$Main$Running(
									_elm_lang$core$Native_Utils.update(
										_p9,
										{log: log}));
							case 'Stop':
								return _user$project$Main$Stopped(_p7._1._0);
							default:
								break _v3_8;
						}
					default:
						switch (_p7._0.ctor) {
							case 'Resume':
								return _user$project$Main$Running(_p7._1._0);
							case 'Reset':
								var _p10 = _p7._1._0;
								return _user$project$Main$Running(
									_elm_lang$core$Native_Utils.update(
...
var _user$project$Main$update = F2(
	function (msg, model) {
		return {
			ctor: '_Tuple2',
			_0: A2(_user$project$Main$simpleUpdate, msg, model),
...
var _user$project$Main$Remember = {ctor: 'Remember'};
var _user$project$Main$viewWithState = F2(
	function (_p11, state) {
		var _p12 = _p11;
		var buttons = _p12.active ? {
			ctor: '::',
			_0: A2(
				_rundis$elm_bootstrap$Bootstrap_Button$button,
				{
					ctor: '::',
					_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(_user$project$Main$Stop),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(_user$project$Main$Remember),
						_1: {
							ctor: '::',
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Remember'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(_user$project$Main$Reset),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(_user$project$Main$Resume),
						_1: {
							ctor: '::',
							_0: _rundis$elm_bootstrap$Bootstrap_Button$primary,
							_1: {ctor: '[]'}
		...
		return _rundis$elm_bootstrap$Bootstrap_Card$view(
			A2(
				_user$project$Main$viewLog,
				state,
				A2(
					_user$project$Main$viewNow,
					state,
					A3(
						_rundis$elm_bootstrap$Bootstrap_Card$block,
						{ctor: '[]'},
...
var _user$project$Main$subscriptions = function (model) {
	...
	switch (_p13.ctor) {
		case 'Started':
			return _user$project$Main$ticks;
		case 'Running':
			return _user$project$Main$ticks;
		default:
			return _elm_lang$core$Platform_Sub$none;
...
var _user$project$Main$viewWithoutState = function (_p14) {
	var _p15 = _p14;
	var options = _p15.active ? {
		ctor: '::',
		_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(_user$project$Main$Start),
		_1: {
			ctor: '::',
			_0: _rundis$elm_bootstrap$Bootstrap_Button$primary,
			_1: {ctor: '[]'}
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: function () {
									...
									switch (_p16.ctor) {
										case 'Loaded':
											return _user$project$Main$viewWithoutState(
												{active: true});
										case 'Started':
											return _user$project$Main$viewWithoutState(
												{active: false});
										case 'Running':
											return A2(
												_user$project$Main$viewWithState,
												{active: true},
												_p16._0);
										default:
											return A2(
